/*
  ...
  Purpose: Using different functions to apply various filters and in the process displaying and saving the frame
  Additional tasks performed here include capturing short video sequences , saving the sepia frame with vignetting
