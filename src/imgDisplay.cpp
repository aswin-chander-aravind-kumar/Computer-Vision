/*
  ...
  Purpose: Using different functions to apply various filters and in the process displaying and saving the frames.
  The key difference here from the vidDisplay.cpp is that we are applying different filters on still images.
  Additional tasks performed includes providing captions in the images
